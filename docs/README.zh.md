...
| 主题 | 文档 |
| --- | --- |
| 仓库目录 | [仓库目录](./development/repository-layout.zh.md) |
| 生成方式选择 | [Hunyuan 与 SAM3D 对比](./guides/generation-guide.zh.md) |
| 总体架构 | [架构和调用关系](./development/architecture.zh.md) |
