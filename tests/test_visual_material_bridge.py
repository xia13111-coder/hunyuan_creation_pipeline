...
class VisualMaterialBridgeTests(unittest.TestCase):
    ...
    def test_config_paths_are_resolved_and_validated(self) -> None:
        ...
        self.assertFalse(config.source_material_binding_propagation)
        self.assertEqual(
    ...
    def test_config_accepts_catalog_family_first_material_prediction(self) -> None:
        ...
        self.assertTrue(config.source_material_binding_propagation)
    ...
    def test_family_first_profile_has_identity_only_contract(self) -> None:
        ...
        self.assertTrue(
            document["materials"]["source_material_binding_propagation"],
        )
        self.assertEqual(
